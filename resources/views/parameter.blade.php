            ...
            <div class="col-md-12">
              <div class="card card-primary">
                <div class="card-body">
                  ...
                  <form method="POST" action="{{ route('parameter') }}">
                    @csrf
                    <input type="hidden" name="id" value="<?= htmlspecialchars($row['id']) ?>">
                    
                    <div class="form-group">
                      <label for="biaya_jual">Biaya Jual</label>
                      <input type="number" name="biaya_jual" class="form-control" id="biaya_jual" value="<?= htmlspecialchars($row['biaya_jual']) ?>" step="0.01" required>
                    </div>
                    
                    <div class="form-group">
                      <label for="naik_turun">Naik Turun</label>
                      <input type="number" name="naik_turun" class="form-control" id="naik_turun" value="<?= htmlspecialchars($row['naik_turun']) ?>" step="0.01" required>
                    </div>
