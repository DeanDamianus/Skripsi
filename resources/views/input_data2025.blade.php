...
if (isset($_GET['id']) && !empty($_GET['id'])) {
    ...
    if ($user_result && mysqli_num_rows($user_result) > 0) {
        ...
        $query_rekap = "SELECT rekap_2025.*, parameter_2025.biaya_jual, parameter_2025.naik_turun,parameter_2025.kepala_petani 
                FROM rekap_2025 
                JOIN parameter_2025 ON parameter_2025.id = 1
                WHERE rekap_2025.id_petani = $id";
...
if (isset($_GET['id_rekap']) && !empty($_GET['id_rekap'])) {
    ...
    // Delete the record
    $query_delete = "DELETE FROM rekap_2025 WHERE id_rekap = $id_rekap";
    ...
    <div class="wrapper">
            ...
            <div class="container">
                ...
                <ul class="navbar-nav">
                    <li class="nav-item d-none d-sm-inline-block">
                      <a href="{{url('/input2025')}}" class="nav-link">Home</a>
                    </li>
                </ul>
        ...
        <section class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <a href="{{ url('/input2025') }}"class="btn btn-outline-dark float-right" style="border-radius: 50%; width: 40px; height: 40px; display: flex; align-items: center; justify-content: center; padding: 0; border: 2px solid black; background-color: transparent;">
